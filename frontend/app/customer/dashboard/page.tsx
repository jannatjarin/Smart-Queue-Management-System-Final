...
export default function CustomerDashboard() {
 ...
 {
 user &&
 <div className="card bg-white shadow-md border mb-8">
 ...
 <div className="stat bg-white shadow border rounded-box">
 ...
 <Link
 href="/services"
 className="card bg-white shadow border hover:shadow-md"
 >
