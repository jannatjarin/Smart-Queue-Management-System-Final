...
export class AuthService {
  ...
  async forgotPassword(email: string) {
    ...
    const nextVersion = user.resetTokenVersion + 1;

    await this.usersService.updateResetTokenVersion(user.id, nextVersion);
  ...
  async resetPassword(token: string, newPassword: string) {
    ...
    await this.usersService.updateResetTokenVersion(
      user.id,
