...
import type { CurrentUserPayload } from '../common/current-user.interface';
...
export class CountersController {
  ...
  findAll(
    ...
    return this.countersService.findAll(user);
  }
  ...
  findOne(
    ...
    return this.countersService.findOne(id, user);
  }
  ...
  updateStatus(
    ...
    return this.countersService.updateStatus(id, dto, user);
  }
}
